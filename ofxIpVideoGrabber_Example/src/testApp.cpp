...
void testApp::loadCameras() {
    ...
    ipcams.push_back(IPCameraDef("http://190.2.143.202/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ...
    ipcams.push_back(IPCameraDef("http://62.177.139.136:8088/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ipcams.push_back(IPCameraDef("http://128.214.194.71/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ...
    ipcams.push_back(IPCameraDef("http://193.254.232.146/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ipcams.push_back(IPCameraDef("http://132.236.64.74/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ...
    ipcams.push_back(IPCameraDef("http://88.116.117.219/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ...
    ipcams.push_back(IPCameraDef("http://82.95.108.223:443/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ipcams.push_back(IPCameraDef("http://208.72.69.117:5632/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ipcams.push_back(IPCameraDef("http://208.72.42.252:5633/axis-cgi/mjpg/video.cgi?resolution=320x240"));
    ...
    ipcams.push_back(IPCameraDef("http://148.61.139.229/axis-cgi/mjpg/video.cgi?resolution=320x240"));
